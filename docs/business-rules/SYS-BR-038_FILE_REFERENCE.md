# SYS-BR-038 — File Reference Integrity
...
1. Business records store stable file references/metadata; private files require authorized access and are not exposed through guessable public filesystem paths.
