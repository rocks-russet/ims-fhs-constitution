# SYS-BR-029 — Session and Security Cleanup Job
...
1. Expired sessions, trusted-device records, rate-limit buckets, and other ephemeral security state are periodically cleaned without deleting required audit history.
