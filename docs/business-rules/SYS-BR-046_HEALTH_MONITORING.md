# SYS-BR-046 — System Health Monitoring
...
1. Health checks cover database connectivity, queue/job health, scheduler execution, market/card refresh freshness, object storage, and critical dependency availability.
