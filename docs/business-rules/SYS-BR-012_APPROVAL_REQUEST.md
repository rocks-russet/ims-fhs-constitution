...
1. Approval request has stable ID, source domain/document, requested action, amount/context where applicable, requester, createdAt, and current status.
