...
1. Backups include the authoritative database and required object/file metadata; restore is a controlled administrative operation with validation before reopening production.
