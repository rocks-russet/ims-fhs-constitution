...
1. History dokumen withdrawal dipisah dari Wallet History.
2. Tampilkan Withdrawal ID, requester, wallet, amount, status, approver, completedAt.
3. Completed Withdrawal link ke wallet debit posting.
