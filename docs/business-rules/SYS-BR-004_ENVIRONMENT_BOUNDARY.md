# SYS-BR-004 — Environment Boundary
...
1. Development, staging, and production environments are isolated; production secrets/data must not be reused casually in non-production.
