...
1. Reusable approval infrastructure stores request, subject, requester, required approvers/thresholds, decisions, status, and audit trail while domain BRs define when approval is mandatory.
