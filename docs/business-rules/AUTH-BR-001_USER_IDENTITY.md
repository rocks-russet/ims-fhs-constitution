# AUTH-BR-001 — System User Identity
...
1. One human = one active system account; stable userId/userCode; identity separate from Contact, ownerCode, walletCode, beneficiary.
