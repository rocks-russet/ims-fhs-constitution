...
1. Maintenance mode can temporarily block mutations while preserving an informative read/login experience as approved; authorization remains enforced.
