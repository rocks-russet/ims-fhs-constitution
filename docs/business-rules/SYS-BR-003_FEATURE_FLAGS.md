...
1. Feature flags may enable/disable approved capabilities without deleting data; flags are environment-aware, auditable, and never bypass authorization.
