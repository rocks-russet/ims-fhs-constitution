# AUTH-BR-022 — Personal Dashboard Context
...
1. Login resolves default owner context for Wallet + Inventory Portfolio; authorized users may switch permitted scopes; holder does not define portfolio ownership.
