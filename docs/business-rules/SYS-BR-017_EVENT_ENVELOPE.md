...
1. Every event carries eventId, eventType, aggregate/domain owner, sourceId, occurredAt, schemaVersion, correlationId, causationId where applicable, and payload.
