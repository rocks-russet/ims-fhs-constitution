...
1. Server-side password policy favors sufficient length/entropy; reject trivial/common credentials where safely supported; never return password data to clients.
