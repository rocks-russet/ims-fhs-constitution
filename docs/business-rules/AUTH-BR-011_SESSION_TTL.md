# AUTH-BR-011 — Session TTL and Sliding Expiration
...
1. Baseline TTL 8 hours with sliding expiration and absolute limit; server time authoritative; sensitive actions may require fresh auth.
